           ...
           // Actualizar la interfaz gráfica
            function actualizarCarrito() {
                ...
                carrito.productos.forEach(producto => {
                    ...
                    minusButton.dataset.ref = producto.ref;  // Usamos ref como identificador
                    minusButton.innerText = '-';
    
                    const plusButton = document.createElement('button');
                    plusButton.classList.add('plus');
                    plusButton.dataset.ref = producto.ref;  // Usamos ref como identificador
                    plusButton.innerText = '+';
    
                    const inputCantidad = document.createElement('input');
                    inputCantidad.type = 'number';
                    inputCantidad.id = `quantity-${producto.ref}`;  // Usamos ref para el id
                    ...
                    totalCelda.id = `total-${producto.ref}`;  // Usamos ref para el id
